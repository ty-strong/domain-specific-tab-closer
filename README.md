...
Since this extension is in development, you can load it manually into any Chromium-based browser (I recommend not using the Firefox version right now, since I plan to rework it, so we'll use Brave as an example):
